  ...
  return (
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          I am a freelancer and a full stack developer who lives in Busan and is
          working. Basically, I&apos;m interested in IT services as a whole, and
          I&apos;m putting a lot of effort into creating app applications and
          webs. I like to plan and design from product database to launch.{' '}
